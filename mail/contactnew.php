...
<select name="dropdown">
    ...
    <option value="1">For bio medical research</option>
    <option value="2">For social science</option>
    <option value="3"> For big </option>
    <option value="4">For business 
</option>
  </select>
...
<h3><?php include "contactnewphp.php"?></h3>
</div>
