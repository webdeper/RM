    <title>STATISTICAL ENQUIRY | Research Mentor</title>
    ...
    <div class="jumbotron" id="jumbointro">
    	<div class="container">
    		<div class="col-md-6">
    			<h1 class="display-4">Statistical Enquiry</h1>
    		</div>
    ...
    <div class="jumbotron contact" id="main-info">
    	...
    	<br>
			<p class="lead">
				Research Mentor's statistical analysis team provides the most accurate and fastest statistical analysis services in an optimal way. <br><br>
If you would like to speak with a research mentor, it is the fastest way to contact us at 1522-4821
			</p>
    	<div class="row">
    		<div class="col-md-2"></div>
    	<div class="col-md-10">
    	<h3>Enquiry about Statistical Issue</h3>
    	<br>
...
<br>
    ...
    <option selected>Statistical Analysis Classification</option>
   <option value="For bio medical research">Medical Research</option>
    <option value="For social science">Social Science Research</option>
    <option value=" For big">Big Data, Enterprise </option>
   	...
   	<br>
   	 ...
   	 <p><?php include 'secure_contact_stat_form.php';  ?></p>
    	</form>
    	</div>
    	</div>
		</div>
